...
Put the files containing the sensor data (file `onboardeu_001.h5`) and the railway network geometries (file `braunschweig_port_railway_network.gpkg`, both available via the link (https://doi.org/10.5281/zenodo.16368240)) into the `data` folder of the repository.
